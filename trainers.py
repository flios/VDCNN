...
class Trainer():
    ...
    def train(self):
        ...
        for val_inputs, val_targets in self.val_dataloader:
            ...
            self.val_batch_losses.append(val_batch_loss.data.item())
            self.val_batch_metrics.append(val_batch_metric.data.item())
        ...
        epoch_loss = np.sum(self.batch_losses)/ train_data_size
        epoch_metric = np.sum(self.batch_metrics)/ train_data_size
        ...
        val_epoch_loss = np.sum(self.val_batch_losses)/ val_data_size
        val_epoch_metric = np.sum(self.val_batch_metrics)/ val_data_size
